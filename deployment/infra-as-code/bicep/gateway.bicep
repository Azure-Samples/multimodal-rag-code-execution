...
@description('The availability zones to use for resources that support them')
param availabilityZones array

@description('The URI of the secret containing the certificate for the App Gateway')
...
@description('The name of the subnet for the App Gateway')
...
//variables
var appGateWayName = '${namePrefix}agw${uniqueid}'
var appGatewayManagedIdentityName = 'id-${appGateWayName}'
var appGatewayPublicIpName = 'pip-${uniqueid}'
var appGateWayFqdn = 'fe-${uniqueid}'
var wafPolicyName= 'waf-${uniqueid}'
    ...
    backendHttpSettingsCollection: [
      {
        ...
        properties: {
          ...
          requestTimeout: 20
          probe: {
            id: resourceId('Microsoft.Network/applicationGateways/probes', appGateWayName, 'probe-web${uniqueid}')
          }
        }
      }
    ]
